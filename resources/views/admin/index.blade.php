		...
		<div class="col-xl-3 col-lg-6">
			<div class="card mb-3">
				<div class="card-body">
					...
					<div class="row align-items-center mb-2">
						<div class="col-7">
							<h3 class="mb-0">{{$emailDay->jumlah}}</h3>
						</div>
						<div class="col-5">
							<div class="mt-n2" data-render="apexchart" data-type="bar" data-title="Visitors"
								data-height="30">
		...
		<div class="col-xl-3 col-lg-6">
			<div class="card mb-3">
				<div class="card-body">
					...
					<div class="small text-white text-opacity-50 text-truncate">
						<i class="fa fa-chevron-up fa-fw me-1"></i> {{$jammingDay->jumlah}} Permintaan Jamming Hari ini<br />
						<i class="far fa-user fa-fw me-1"></i> {{$jammingMonth->jumlah}} Permintaan Jamming Bulan ini<br />
		...
		<div class="col-xl-3 col-lg-6">
			<div class="card mb-3">
				<div class="card-body">
					...
					<div class="small text-white text-opacity-50 text-truncate">
						<i class="fa fa-chevron-up fa-fw me-1"></i> {{$insidenDay->jumlah}} Laporan Insiden Hari ini<br />
		...
		<div class="col-xl-6">
			...
			<div class="card mb-3">
				...
				<div class="card-body">
					...
					<div class="d-flex fw-bold small mb-3">
						<span class="flex-grow-1">ACTIVITY LOG USER</span>
						<a href="#" data-toggle="card-expand" class="text-white text-opacity-50 text-decoration-none"><i
								class="bi bi-fullscreen"></i></a>
					</div>
					...
					<div class="table-responsive">
						<table class="table table-striped table-borderless mb-2px small text-nowrap">
							<tbody>
								@foreach($logs_user as $key => $log_user)
								...
								<tr>
									<td>
										<span class="d-flex align-items-center">
											...
											{{$log_user->nama}} : {{$log_user->activity}}
										</span>
									</td>
		...
		<div class="col-xl-6">
			...
			<div class="card mb-3">
				...
				<div class="card-body">
					...
					<div class="d-flex fw-bold small mb-3">
						<span class="flex-grow-1">ACTIVITY LOG TEKNISI JARINGAN</span>
						<a href="#" data-toggle="card-expand" class="text-white text-opacity-50 text-decoration-none"><i
								class="bi bi-fullscreen"></i></a>
					</div>
