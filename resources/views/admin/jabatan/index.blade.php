    ...
    <div class="row justify-content-center">
      ...
      <div class="col-xl-12">
        ...
        <div class="row">
          ...
          @endif
          <div class="col-xl-12">
            <button type="button" onclick="showModal()" class="btn btn-theme">Tambah Jabatan</button>
            <hr/>
            <h3 class="page-header">
              Master Jabatan
            </h3>
          <!-- <a href="{{ route('jabatan_sync') }}" type="button" class="btn btn-theme">
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form class="form-horizontal form-label-left" action="{{route('jabatan_post')}}" method="POST">
          {{ csrf_field() }}
          <div class="form-group">
            <label class="control-label col-md-3" for="first-name">Nama Jabatan<span class="required">*</span>
            </label>
            <div class="col-md-7">
              <input type="text" id="nama_jab" name="nama_jab" required="required"
  ...
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal form-label-left" action="/admin/jabatan/delete" method="POST">
          {{ csrf_field() }}
...
@section('script')
  ...
  function showEditModal(id) {
    $.getJSON('/admin/jabatan/getDataById/' + id, function (response) {
      if (response) {
        $('#id_table').val(response.id);
        $('#nama_jab').val(response.nama_jab);
      }
    });
    $('#tambah').modal('show');
  }
  ...
  $('#members-table').DataTable({
    ...
    serverSide: true,
    method: 'GET',
    ajax: '{{URL::to("/admin/jabatan/getdata")}}',
    columns: [
      { data: 'DT_RowIndex', name: 'DT_RowIndex', orderable: false, searchable: false },
      { data: 'nama_jab', name: 'nama_jab' },
