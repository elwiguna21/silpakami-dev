...
{{-- modal approve --}}
<div id="aproved" class="modal fade">
  <div class="modal-dialog modal-sm">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal form-label-left" action="{{route('pencabutanaprove')}}" method="POST">
          {{ csrf_field() }}
...
<div class="modal fade bs-example-modal-lg" id="denied" tabindex="-1" role="dialog" aria-hidden="true">
  <form class="form-horizontal form-label-left" action="{{route('pencabutandenied')}}" method="POST">
...
<script>
  ...
  $('#members-table').DataTable({
    ...
    serverSide: true,
    method: 'GET',
    ajax: '{{URL::to("/admin/sertifikat/pencabutan/getdata")}}',
    columns: [
