        ...
        <div class="row">
          ...
          <div class="col-xl-12">
            ...
            <h3 class="page-header">
              Pengajuan Pembuatan Email <small>per SKPD</small>
            </h3>
...
<div id="ajukan" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form action="{{Route('pengajuanEmailInsert')}}" method="POST" enctype="multipart/form-data">

        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel">Pengajuan Pembuatan Email</h4>
        ...
        <div class="modal-body">
          ...
          <p> - Contoh Surat Permohonan pembuatan email<a href="/file/Surat Pembuatan E-mail.docx">
...
<script>
  ...
  $('#members-table').DataTable({
    ...
    serverSide: true,
    method: 'GET',
    ajax: '{{URL::to("/user/pengajuan_email/getdata")}}',
    columns: [
