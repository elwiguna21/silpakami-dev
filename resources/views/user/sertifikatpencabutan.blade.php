        ...
        <div class="row">
          ...
          <div class="col-xl-12">
            <button type="button" class="btn btn-theme" data-bs-toggle="modal" data-bs-target="#ajukan">Ajukan
              Pencabutan Sertifikat</button>
            <hr class="mb-4" />

            <h3 class="page-header">
              Pengajuan Pencabutan Sertifikat <small>per SKPD</small></h3>
            <hr class="mb-4" />
                  ...
                  <table id="members-table" class="table table-responsive">
                    <thead>
                      <tr>
                        ...
                        <th>Status</th>
                        <th>Action</th>
                        <th>Alasan Penolakann (Jika ditolak)</th>
                      </tr>
                    </thead>
                  </table>
                </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">Pengajuan Pencabutan Sertifikat Elektronik</h4>
      ...
      <div class="modal-body">
        ...
        <p> - Contoh Surat Permohonan Pencabutan SE <a href="/file/Form Pencabutan Sertifikat Elektronik.docx">
        ...
        <form action="{{Route('pencabutanseinsert')}}" method="POST" enctype="multipart/form-data">
          {{ csrf_field() }}
          <div class="mb-3 row">
          ...
          <div class="mb-3 row">
            <label class="col-sm-3 col-form-label">Upload Dokumen Pencabutan</label>
            <div class="col-sm-9">
...
<div class="modal fade bs-example-modal-lg" id="published" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <div class="modal-header">
        <h4 class="modal-title" id="myModalLabel">Pencabutan Selesai</h4>
        <button type="button" class="btn-close" data-bs-dismiss="modal"></button>
      </div>
      <div class="modal-body">
        Anda Yakin Pencabutan telah Selesai ?
        <form class="form-horizontal form-label-left" action="{{route('pencabutanpublished')}}" method="POST">
          {{ csrf_field() }}
      ...
      <div class="modal-footer">
        ...
        <button type="submit" class="btn btn-theme">Ya</button>
        </form>
      </div>
...
<script>
  ...
  $('#members-table').DataTable({
    ...
    serverSide: true,
    method: 'GET',
    ajax: '{{URL::to("/user/pencabutan_se/getdata")}}',
    columns: [
