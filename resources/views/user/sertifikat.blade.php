        ...
        <div class="row">
          ...
          <div class="col-xl-12">
            ...
            <h3 class="page-header">
              Pengajuan Pembuatan Sertifikat <small>per SKPD</small>
            </h3>
...
<div id="ajukan" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      <form action="{{Route('pengajuanseinsert')}}" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-body">
          ...
          <p> - Contoh Surat Rekomendasi Untuk 1 Orang<a href="/file/Surat Rekomendasi 1 Orang.pdf">
              [Download Dokumen]</a></p>
          <p> - Contoh Surat Rekomendasi Untuk 2 Orang atau Lebih<a
              href="/file/Surat Rekomendasi 2 Orang Atau Lebih.pdf">
              [Download Dokumen]</a></p>
          ...
          <!-- <div class="form-group row">
            <label class="col-sm-2 col-form-label">Upload KTP Berwana (PNG, JPG, JPEG)</label>
            <div class="col-sm-10">
              <input id="input-23" name="ktp" type="file">
            </div>
          </div> -->
          <div class="mb-3 row">
            <label class="col-sm-3 col-form-label">Upload Dokumen (pdf)</label>
            <div class="col-sm-9">
              <input id="input-24" name="files" class="form-control" type="file">
            </div>
          </div>
        </div>
  ...
  <div class="modal-dialog modal-lg">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form class="form-horizontal form-label-left" action="{{route('pembuatanpublished')}}" method="POST">
          {{ csrf_field() }}
...
<script>
  ...
  $('#members-table').DataTable({
    ...
    serverSide: true,
    method: 'GET',
    ajax: '{{URL::to("/user/pengajuan_se/getdata")}}',
    columns: [
