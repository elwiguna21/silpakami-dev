...
<body>
  ...
  <div id="app" class="app">
    ...
    <div id="header" class="app-header">
      ...
      <div class="brand">
        <a href="#" class="brand-logo">
          ...
          <span class="brand-text">SILPaKAMI || ADMIN</span>
        </a>
      </div>
    ...
    $laporanInsiden = 'menu-item';

    $dataMaster = 'menu-item has-sub';
    $jabatan = 'menu-item';
    $golongan = 'menu-item';
    $unitKerja = 'menu-item';

    $monitoring = 'menu-item has-sub';
    $daftarWebsite = 'menu-item';
    $daftarTelegram = 'menu-item';
    $konfigurasiTelegram = 'menu-item';
    $logLaporan = 'menu-item';
    ...
    if($item == 'dashboard'){
      ...
      $sertifikat = 'menu-item has-sub active';
    }else if($item == 'dataP12'){
      $dataP12 = 'menu-item active';
      $sertifikat = 'menu-item has-sub active';
    ...
    }else if($item == 'laporanInsiden'){
      $laporanInsiden = 'menu-item active';
      $incidentHandling = 'menu-item has-sub active';
    }else if($item == 'jabatan'){
      $jabatan = 'menu-item active';
      $dataMaster = 'menu-item has-sub active';
    }else if($item == 'golongan'){
      $golongan = 'menu-item active';
      $dataMaster = 'menu-item has-sub active';
    }else if($item == 'unitKerja'){
      $unitKerja = 'menu-item active';
      $dataMaster = 'menu-item has-sub active';
    }else if($item == 'daftarWebsite'){
      $daftarWebsite = 'menu-item active';
      $monitoring = 'menu-item has-sub active';
    }else if($item == 'daftarTelegram'){
      $daftarTelegram = 'menu-item active';
      $monitoring = 'menu-item has-sub active';
    }else if($item == 'konfigurasiTelegram'){
      $konfigurasiTelegram = 'menu-item active';
      $monitoring = 'menu-item has-sub active';
    }else if($item == 'logLaporan'){
      $logLaporan = 'menu-item active';
      $monitoring = 'menu-item has-sub active';
    }else if($item == 'akun'){
          ...
          <div class="{{$email}}">
            ...
            <div class="menu-submenu">
              <div class="{{$pembuatanEmail}}">
                <a href="{{route('adminemail')}}" class="menu-link">
          ...
          <div class="{{$sertifikat}}">
            ...
            <div class="menu-submenu">
              <div class="{{$pendaftaranSE}}">
                <a href=" {{route('adminpembuatan')}}" class="menu-link">
                  <span class="menu-text">Pendaftaran</span>
                </a>
              </div>
              <div class="{{$perubahanSE}}">
                <a href=" {{route('adminperubahan')}}" class="menu-link">
                  <span class="menu-text">Perubahan</span>
                </a>
              </div>
              <div class="{{$pencabutanSE}}">
                <a href=" {{route('adminpencabutan')}}" class="menu-link">
                  <span class="menu-text">Pencabutan</span>
                </a>
              </div>
              <div class="{{$dataP12}}">
                <a href="{{route('adminp12')}}" class="menu-link">
                  <span class="menu-text">Data SE</span>
                </a>
              </div>
            </div>
          </div>
          <div class="{{$layananJamming}}">
            ...
            <div class="menu-submenu">
              <div class="{{$permintaanLayanan}}">
                <a href="{{route('adminlayanan')}}" class="menu-link">
          ...
          <div class="{{$layananPentest}}">
            ...
            <div class="menu-submenu">
              <div class="{{$permintaanPentest}}">
                <a href="{{route('adminpentest')}}" class="menu-link">
          ...
          <div class="{{$incidentHandling}}">
            ...
            <div class="menu-submenu">
              <div class="{{$insidenHandling}}">
                <a href="{{route('adminincident')}}" class="menu-link">
                  <span class="menu-text">Insiden Handling</span>
                </a>
              </div>
              <!-- <div class="{{$laporanInsiden}}">
                <a href="{{route('adminlaporan')}}" class="menu-link">
                  <span class="menu-text">Laporan Insiden</span>
                </a>
              </div> -->
            </div>
          </div>
          <div class="menu-header">Parameter</div>
          <div class="{{$dataMaster}}">
            <a href="#" class="menu-link">
            ...
            <div class="menu-submenu">
              ...
              <div class="{{$golongan}}">
                <a href="{{route('golongan')}}" class="menu-link">
                  <span class="menu-text">Golongan</span>
                </a>
              </div>
              <div class="{{$unitKerja}}">
                <a href="{{route('unitKerja')}}" class="menu-link">
                  <span class="menu-text">Unit kerja</span>
                </a>
              </div>
            </div>
          </div>
          <div class="menu-header">Log</div>
          <div class="{{$monitoring}}">
            <a href="#" class="menu-link">
              <span class="menu-icon"><i class="bi bi-pie-chart"></i></span>
              <span class="menu-text">Monitoring Website</span>
              <span class="menu-caret"><b class="caret"></b></span>
            </a>
            <div class="menu-submenu">
              <div class="{{$daftarWebsite}}">
                <a href="{{route('sites')}}" class="menu-link">
                  <span class="menu-text">Daftar Website</span>
                </a>
              </div>
              <div class="{{$daftarTelegram}}">
                <a href="{{route('telegrams')}}" class="menu-link">
                  <span class="menu-text">Daftar Telegram</span>
                </a>
              </div>
              <div class="{{$konfigurasiTelegram }}">
                <a href="{{route('telegram.config.page')}}" class="menu-link">
                  <span class="menu-text">Konfigurasi Telegram</span>
                </a>
              </div>
              <div class="{{$logLaporan}}">
                <a href="{{route('site.logs')}}" class="menu-link">
                  <span class="menu-text">Log Laporan</span>
                </a>
              </div>
            </div>
          </div>
