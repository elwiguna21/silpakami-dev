                        ...
                        <div class="card">
                            <div class="card-body">
                                <form action="{{route('site.update')}}" method="post" id="form-add">
                                    ...
                                    <input name="redirect" value="site.addform" hidden>
                                    <div class="row">
                                        <div class="col-xl-12">
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="selectpicker form-control" id="ex-multiselect"
                                                    multiple="multiple" name="telegram_id[]">
...
@endsection
@section('script')
<script src="{{asset('hud/plugins/jquery-migrate/dist/jquery-migrate.min.js')}}"></script>
